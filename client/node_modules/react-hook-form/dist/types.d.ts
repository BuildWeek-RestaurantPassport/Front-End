...
export declare type FieldName<FormValues extends FieldValues> = keyof FormValues & string;
...
export declare type FieldErrors<FormValues> = {
    [Key in keyof FormValues]?: FormValues[Key] extends any[] ? FormValues[Key][number] extends object ? FieldErrors<FormValues[Key][number]>[] : FieldError : FormValues[Key] extends object ? FieldErrors<FormValues[Key]> : FieldError;
};
