...
var filterArray = function (target) {
    for (var key in target) {
        if (isArray(target[key])) {
            target[key] = target[key].filter(function (data) { return !isNullOrUndefined(data); });
...
var transformToNestObject = (function (data) {
    return filterArray(Object.entries(data).reduce(function (previous, _a) {
        var _b;
...
function useForm(_a) {
    ...
    var executeValidation = useCallback(function (name, shouldRender, skipReRender) { return __awaiter(_this, void 0, void 0, function () {
        var field, error;
    ...
    var executeSchemaValidation = useCallback(function (payload, shouldRender) { return __awaiter(_this, void 0, void 0, function () {
        var errors, previousFormIsValid, fieldName, error;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, validateWithSchema(validationSchema, validateAllFieldCriteria, transformToNestObject(getFieldsValues(fieldsRef.current)))];
                case 1:
                    ...
                    if (isArray(payload)) {
                        ...
                        renderBaseOnError(fieldName, error ? (_a = {}, _a[fieldName] = error, _a) : {}, shouldRender || previousFormIsValid !== isValidRef.current);
                    }
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, validateWithSchema(validationSchema, validateAllFieldCriteria, transformToNestObject(getFieldsValues(fields)))];
                        case 1:
    ...
    var validateSchemaIsValid = useCallback(function () {
        var fieldValues = isEmptyObject(defaultValuesRef.current)
            ...
            : defaultValuesRef.current;
        validateFieldsSchemaCurry(transformToNestObject(fieldValues)).then(function (_a) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, validateFieldsSchemaCurry(transformToNestObject(fieldValues))];
                case 2:
...
var Controller = function (_a) {
    var _b, _c;
    var name = _a.name, rules = _a.rules, InnerComponent = _a.as, onChange = _a.onChange, onBlur = _a.onBlur, onChangeName = _a.onChangeName, onBlurName = _a.onBlurName, _d = _a.control, defaultValues = _d.defaultValues, fields = _d.fields, setValue = _d.setValue, register = _d.register, unregister = _d.unregister, errors = _d.errors, _e = _d.mode, isOnSubmit = _e.isOnSubmit, isOnBlur = _e.isOnBlur, _f = _d.reValidateMode, isReValidateOnBlur = _f.isReValidateOnBlur, isReValidateOnSubmit = _f.isReValidateOnSubmit, isSubmitted = _d.formState.isSubmitted, rest = __rest(_a, ["name", "rules", "as", "onChange", "onBlur", "onChangeName", "onBlurName", "control"]);
    var _g = __read(React.useState(isUndefined(defaultValues[name]) ? '' : defaultValues[name]), 2), value = _g[0], setInputStateValue = _g[1];
    ...
    var eventWrapper = function (event, eventName) { return function () {
        var arg = [];
    ...
    React.useEffect(function () { return function () { return unregister(name); }; }, []);
    var props = __assign(__assign(__assign(__assign({}, (onChange
        ? (_b = {},
            _b[onChangeName || VALIDATION_MODE.onChange] = eventWrapper(onChange, VALIDATION_MODE.onChange),
            _b) : { onChange: handleChange })), (isOnBlur || isReValidateOnBlur
        ? onBlur
            ? (_c = {},
                _c[onBlurName || VALIDATION_MODE.onBlur] = eventWrapper(onBlur, VALIDATION_MODE.onBlur),
                _c) : { onBlur: handleBlur }
        : {})), (isCheckboxInput ? { checked: value } : { value: value })), rest);
